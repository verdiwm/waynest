        ...
        pub trait WlRegistry: crate::server::Dispatcher {
            ...
            fn global_remove(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(name).build();
                    client
                        .send_message(crate::Message::new(sender_id, 1u16, payload, fds))
                        .await
                }
        ...
        pub trait WlCallback: crate::server::Dispatcher {
            ...
            fn done(
                ...
                async move {
                    ...
                    let (payload, fds) =
                        crate::PayloadBuilder::new().put_uint(callback_data).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
        ...
        pub trait WlDataSource: crate::server::Dispatcher {
            ...
            fn target(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_string(mime_type).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        9u16 => {
                            ...
                            self.set_class(client, sender_id, class).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
