                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.create_inhibitor(client, sender_id, id, surface).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
        ...
        pub trait ZwpInputMethodContextV1: crate::server::Dispatcher {
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        9u16 => {
                            ...
                            self.grab_keyboard(client, sender_id, keyboard).await
                        }
                        10u16 => {
                            let serial = message.uint()?;
                            let time = message.uint()?;
                            ...
                            self.key(client, sender_id, serial, time, key, state).await
                        }
                        11u16 => {
                            let serial = message.uint()?;
            ...
            fn commit_state(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(serial).build();
                    client
                ...
                async move {
                    ...
                    match message.opcode() {
                        0u16 => {
                            ...
                            self.get_input_panel_surface(client, sender_id, id, surface)
                                .await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                ...
                async move {
                    ...
                    match message.opcode() {
                        0u16 => {
                            ...
                            self.set_toplevel(client, sender_id, output, position).await
                        }
                        1u16 => {
                            tracing::debug!(
                            ...
                            self.set_overlay_panel(client, sender_id).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        2u16 => {
                            ...
                            self.get_pointer_timestamps(client, sender_id, id, pointer)
                                .await
                        }
                        3u16 => {
                            let id = message
                            ...
                            self.get_touch_timestamps(client, sender_id, id, touch)
                                .await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
        ...
        pub trait ZwpLinuxDmabufFeedbackV1: crate::server::Dispatcher {
            ...
            fn tranche_formats(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_array(indices).build();
                    client
                        .send_message(crate::Message::new(sender_id, 5u16, payload, fds))
                        .await
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.set_acquire_fence(client, sender_id, fd).await
                        }
                        2u16 => {
                            let release = message
                                .object()?
                            ...
                            self.get_release(client, sender_id, release).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
        ...
        pub trait ZwpLinuxBufferReleaseV1: crate::server::Dispatcher {
            ...
            fn fenced_release(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_fd(fence).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.set_cursor_position_hint(client, sender_id, surface_x, surface_y)
                                .await
                        }
                        2u16 => {
                            let region = message.object()?;
                ...
                async move {
                    ...
                    match message.opcode() {
                        0u16 => {
                            ...
                            self.get_swipe_gesture(client, sender_id, id, pointer).await
                        }
                        1u16 => {
                            let id = message
                                .object()?
                            ...
                            self.get_pinch_gesture(client, sender_id, id, pointer).await
                        }
                        2u16 => {
                        ...
                        3u16 => {
                            ...
                            self.get_hold_gesture(client, sender_id, id, pointer).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        0u16 => {
                            ...
                            self.create_source(client, sender_id, id).await
                        }
                        1u16 => {
                            let id = message
                                .object()?
                            ...
                            self.get_device(client, sender_id, id, seat).await
                        }
                        2u16 => {
                            tracing::debug!(
        ...
        pub trait ZwpPrimarySelectionDeviceV1: crate::server::Dispatcher {
            ...
            fn data_offer(
                ...
                async move {
                    ...
                    let (payload, fds) =
                        crate::PayloadBuilder::new().put_object(Some(offer)).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.get_relative_pointer(client, sender_id, id, pointer)
                                .await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
    ...
    pub mod zwp_relative_pointer_v1 {
        ...
        pub trait ZwpRelativePointerV1: crate::server::Dispatcher {
            ...
            fn relative_motion(
                ...
                dx: crate::Fixed,
                dy: crate::Fixed,
                dx_unaccel: crate::Fixed,
                dy_unaccel: crate::Fixed,
            ) -> impl Future<Output = crate::server::Result<()>> + Send {
                async move {
                    tracing::debug!(
        ...
        pub trait ZwpTabletToolV1: crate::server::Dispatcher {
            ...
            fn pressure(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(pressure).build();
                    client
            ...
            fn distance(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(distance).build();
                    client
                        .send_message(crate::Message::new(sender_id, 12u16, payload, fds))
                        .await
                }
            }
            #[doc = ""]
            ...
            fn tilt(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new()
                        ...
                        .build();
                    client
                        .send_message(crate::Message::new(sender_id, 13u16, payload, fds))
                        .await
                }
            }
            #[doc = ""]
            ...
            fn rotation(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_int(degrees).build();
                    client
                        .send_message(crate::Message::new(sender_id, 14u16, payload, fds))
                        .await
                }
            }
            #[doc = ""]
            ...
            fn slider(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_int(position).build();
                    client
                        .send_message(crate::Message::new(sender_id, 15u16, payload, fds))
                        .await
                }
            }
            #[doc = ""]
            ...
            fn wheel(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new()
                        ...
                        .build();
                    client
                        .send_message(crate::Message::new(sender_id, 16u16, payload, fds))
                        .await
                }
            }
            #[doc = ""]
            ...
            fn button(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new()
                        ...
                        .build();
                    client
                        .send_message(crate::Message::new(sender_id, 17u16, payload, fds))
                        .await
                }
            }
            #[doc = ""]
            ...
            fn frame(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(time).build();
                    client
                        .send_message(crate::Message::new(sender_id, 18u16, payload, fds))
                        .await
                }
            }
        }
        ...
        pub trait ZwpTabletV1: crate::server::Dispatcher {
            ...
            fn path(
                ...
                async move {
                    ...
                    let (payload, fds) =
                        crate::PayloadBuilder::new().put_string(Some(path)).build();
                    client
                        .send_message(crate::Message::new(sender_id, 2u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTabletToolV2: crate::server::Dispatcher {
            ...
            fn rotation(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_fixed(degrees).build();
                    client
                        .send_message(crate::Message::new(sender_id, 14u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTabletPadRingV2: crate::server::Dispatcher {
            ...
            fn source(
                ...
                async move {
                    ...
                    let (payload, fds) =
                        crate::PayloadBuilder::new().put_uint(source as u32).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTabletPadStripV2: crate::server::Dispatcher {
            ...
            fn position(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(position).build();
                    client
                        .send_message(crate::Message::new(sender_id, 1u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTabletPadGroupV2: crate::server::Dispatcher {
            ...
            fn buttons(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_array(buttons).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
            ...
            fn ring(
                ...
                async move {
                    ...
                    let (payload, fds) =
                        crate::PayloadBuilder::new().put_object(Some(ring)).build();
                    client
                        .send_message(crate::Message::new(sender_id, 1u16, payload, fds))
                        .await
                }
            ...
            fn strip(
                ...
                client: &mut crate::server::Client,
                sender_id: crate::ObjectId,
                strip: crate::ObjectId,
            ) -> impl Future<Output = crate::server::Result<()>> + Send {
                async move {
                    tracing::debug!("-> zwp_tablet_pad_group_v2#{}.strip({})", sender_id, strip);
                    let (payload, fds) =
                        crate::PayloadBuilder::new().put_object(Some(strip)).build();
                    client
                        .send_message(crate::Message::new(sender_id, 2u16, payload, fds))
                        .await
                }
            ...
            fn modes(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(modes).build();
                    client
                        .send_message(crate::Message::new(sender_id, 3u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTabletPadV2: crate::server::Dispatcher {
            ...
            fn buttons(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(buttons).build();
                    client
                        .send_message(crate::Message::new(sender_id, 2u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTextInputV1: crate::server::Dispatcher {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            let seat = message
                                .object()?
                                .ok_or(crate::DecodeError::MalformedPayload)?;
                            tracing::debug!("zwp_text_input_v1#{}.deactivate({})", sender_id, seat);
            ...
            fn modifiers_map(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_array(map).build();
                    client
                        .send_message(crate::Message::new(sender_id, 2u16, payload, fds))
                        .await
                }
            ...
            fn preedit_cursor(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_int(index).build();
                    client
                        .send_message(crate::Message::new(sender_id, 6u16, payload, fds))
                        .await
                }
        ...
        pub trait ZwpTextInputV3: crate::server::Dispatcher {
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.enable(client, sender_id).await
                        }
                        2u16 => {
                            tracing::debug!("zwp_text_input_v3#{}.disable()", sender_id,);
                            self.disable(client, sender_id).await
                        }
                        3u16 => {
                            let text = message
                                .string()?
                        ...
                        4u16 => {
                            ...
                            self.set_text_change_cause(client, sender_id, cause.try_into()?)
                                .await
                        }
                        5u16 => {
                            let hint = message.uint()?;
            ...
            fn commit_string(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_string(text).build();
                    client
                        .send_message(crate::Message::new(sender_id, 3u16, payload, fds))
                        .await
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.get_toplevel_decoration(client, sender_id, id, toplevel)
                                .await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
        ...
        pub trait ZxdgToplevelDecorationV1: crate::server::Dispatcher {
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        2u16 => {
                            ...
                            self.unset_mode(client, sender_id).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
            ...
            fn configure(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(mode as u32).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.export(client, sender_id, id, surface).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.import(client, sender_id, id, handle).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.set_parent_of(client, sender_id, surface).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.export_toplevel(client, sender_id, id, surface).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.import_toplevel(client, sender_id, id, handle).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.get_xdg_output(client, sender_id, id, output).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            self.use_unstable_version(client, sender_id, version).await
                        }
                        2u16 => {
                            let id = message
                                .object()?
                        ...
                        3u16 => {
                            ...
                            self.get_xdg_popup(
                                client, sender_id, id, surface, parent, seat, serial, x, y,
                            )
                            .await
                        }
                        4u16 => {
                            let serial = message.uint()?;
                            tracing::debug!("xdg_shell#{}.pong({})", sender_id, serial);
                    ...
                    match message.opcode() {
                        ...
                        2u16 => {
                            let title = message
                                .string()?
                                .ok_or(crate::DecodeError::MalformedPayload)?;
                            tracing::debug!("xdg_surface#{}.set_title(\"{}\")", sender_id, title);
                        ...
                        3u16 => {
                            let app_id = message
                                .string()?
                                .ok_or(crate::DecodeError::MalformedPayload)?;
                            tracing::debug!("xdg_surface#{}.set_app_id(\"{}\")", sender_id, app_id);
                        ...
                        5u16 => {
                            let seat = message
                                ...
                                .ok_or(crate::DecodeError::MalformedPayload)?;
                            let serial = message.uint()?;
                            tracing::debug!("xdg_surface#{}.move({}, {})", sender_id, seat, serial);
                        ...
                        6u16 => {
                            ...
                            self.resize(client, sender_id, seat, serial, edges).await
                        }
                        7u16 => {
                            let serial = message.uint()?;
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            let id = message
                                ...
                                .ok_or(crate::DecodeError::MalformedPayload)?;
                            tracing::debug!(
                                "zxdg_shell_v6#{}.create_positioner({})",
                                sender_id,
                                id
                            );
                        ...
                        3u16 => {
                            let serial = message.uint()?;
                            tracing::debug!("zxdg_shell_v6#{}.pong({})", sender_id, serial);
                            self.pong(client, sender_id, serial).await
                        }
                        opcode => Err(crate::server::error::Error::UnknownOpcode(opcode)),
                    }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        2u16 => {
                            ...
                            let height = message.int()?;
                            tracing::debug!(
                                "zxdg_positioner_v6#{}.set_anchor_rect({}, {}, {}, {})",
                                sender_id,
                                x,
                                y,
                                width,
                        ...
                        4u16 => {
                            ...
                            tracing::debug!(
                                "zxdg_positioner_v6#{}.set_gravity({})",
                                sender_id,
                                gravity
                            );
                        ...
                        5u16 => {
                            ...
                            self.set_constraint_adjustment(client, sender_id, constraint_adjustment)
                                .await
                        }
                        6u16 => {
                            let x = message.int()?;
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            let id = message
                                .object()?
                                .ok_or(crate::DecodeError::MalformedPayload)?;
                            tracing::debug!("zxdg_surface_v6#{}.get_toplevel({})", sender_id, id);
                        ...
                        3u16 => {
                            ...
                            let height = message.int()?;
                            tracing::debug!(
                                "zxdg_surface_v6#{}.set_window_geometry({}, {}, {}, {})",
                                sender_id,
                                x,
                                y,
                                width,
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        4u16 => {
                            ...
                            let y = message.int()?;
                            tracing::debug!(
                                "zxdg_toplevel_v6#{}.show_window_menu({}, {}, {}, {})",
                                sender_id,
                                seat,
                                serial,
                                x,
                        ...
                        11u16 => {
                            let output = message.object()?;
                            tracing::debug!(
                                "zxdg_toplevel_v6#{}.set_fullscreen({})",
                                sender_id,
                                output
                                    .as_ref()
                                    .map_or("null".to_string(), |v| v.to_string())
