                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            Requests::get_color_managed_surface(
                                self, client, sender_id, surface, callback,
                            )
                            .await
                        }
                ...
                async move {
                    ...
                    match message.opcode() {
                        ...
                        1u16 => {
                            ...
                            Requests::set_known_transfer_function(
                                self,
                                client,
                                sender_id,
                        ...
                        2u16 => {
                            ...
                            Requests::set_known_container_color_volume(
                                self,
                                client,
                                sender_id,
                                primaries.try_into()?,
