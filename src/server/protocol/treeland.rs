        ...
        pub trait TreelandWindowPickerV1: crate::server::Dispatcher {
            ...
            fn window(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_int(pid).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
        ...
        pub trait TreelandDdm: crate::server::Dispatcher {
            ...
            fn switch_to_vt(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_int(vtnr).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
    ...
    pub mod treeland_foreign_toplevel_manager_v1 {
        ...
        pub trait TreelandForeignToplevelManagerV1: crate::server::Dispatcher {
            ...
            fn get_dock_preview_context(
                ...
                client: &mut crate::server::Client,
                sender_id: crate::ObjectId,
                relative_surface: crate::ObjectId,
                id: crate::ObjectId,
            ) -> impl Future<Output = crate::server::Result<()>> + Send;
            #[doc = ""]
        ...
        pub trait TreelandForeignToplevelHandleV1: crate::server::Dispatcher {
            ...
            fn identifier(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_uint(identifier).build();
                    client
                        .send_message(crate::Message::new(sender_id, 3u16, payload, fds))
                        .await
                }
        ...
        pub trait TreelandVirtualOutputManagerV1: crate::server::Dispatcher {
            ...
            fn virtual_output_list(
                ...
                async move {
                    ...
                    let (payload, fds) = crate::PayloadBuilder::new().put_array(names).build();
                    client
                        .send_message(crate::Message::new(sender_id, 0u16, payload, fds))
                        .await
                }
