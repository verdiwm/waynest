...
pub mod wayland {
    ...
    pub mod wl_display {
        ...
        pub trait WlDisplay {
            ...
            async fn sync(
                ...
                tracing::debug!("-> wl_display#{}.sync()", sender_id);
            ...
            async fn get_registry(
                ...
                tracing::debug!("-> wl_display#{}.get_registry()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
    ...
    pub mod wl_registry {
        ...
        pub trait WlRegistry {
            ...
            async fn bind(
                ...
                tracing::debug!("-> wl_registry#{}.bind()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_uint(name)
                    .put_new_id(id)
                    .build();
    ...
    pub mod wl_compositor {
        ...
        pub trait WlCompositor {
            ...
            async fn create_surface(
                ...
                tracing::debug!("-> wl_compositor#{}.create_surface()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .build();
                client
            ...
            async fn create_region(
                ...
                tracing::debug!("-> wl_compositor#{}.create_region()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .build();
                client
    ...
    pub mod wl_shm_pool {
        ...
        pub trait WlShmPool {
            ...
            async fn create_buffer(
                ...
                tracing::debug!("-> wl_shm_pool#{}.create_buffer()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .put_int(offset)
                    .put_int(width)
            ...
            async fn resize(
                ...
                tracing::debug!("-> wl_shm_pool#{}.resize()", sender_id);
    ...
    pub mod wl_shm {
        ...
        pub trait WlShm {
            ...
            async fn create_pool(
                ...
                tracing::debug!("-> wl_shm#{}.create_pool()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .put_fd(fd)
                    .put_int(size)
    ...
    pub mod wl_data_offer {
        ...
        pub trait WlDataOffer {
            ...
            async fn accept(
                ...
                tracing::debug!("-> wl_data_offer#{}.accept()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_uint(serial)
            ...
            async fn receive(
                ...
                tracing::debug!("-> wl_data_offer#{}.receive()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
            ...
            async fn set_actions(
                ...
                tracing::debug!("-> wl_data_offer#{}.set_actions()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
    ...
    pub mod wl_data_source {
        ...
        pub trait WlDataSource {
            ...
            async fn offer(
                ...
                tracing::debug!("-> wl_data_source#{}.offer()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_string(Some(mime_type))
                    .build();
                client
            ...
            async fn set_actions(
                ...
                tracing::debug!("-> wl_data_source#{}.set_actions()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_uint(dnd_actions.bits())
                    .build();
                client
    ...
    pub mod wl_data_device {
        ...
        pub trait WlDataDevice {
            ...
            async fn start_drag(
                ...
                tracing::debug!("-> wl_data_device#{}.start_drag()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(source)
            ...
            async fn set_selection(
                ...
                tracing::debug!("-> wl_data_device#{}.set_selection()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(source)
                    .put_uint(serial)
                    .build();
    ...
    pub mod wl_data_device_manager {
        ...
        #[allow(unused)]
        use std::os::fd::AsRawFd;
        bitflags::bitflags! { # [doc = ""] # [doc = "This is a bitmask of the available/preferred actions in a"] # [doc = "drag-and-drop operation."] # [doc = ""] # [doc = "In the compositor, the selected action is a result of matching the"] # [doc = "actions offered by the source and destination sides.  \"action\" events"] # [doc = "with a \"none\" action will be sent to both source and destination if"] # [doc = "there is no match. All further checks will effectively happen on"] # [doc = "(source actions ∩ destination actions)."] # [doc = ""] # [doc = "In addition, compositors may also pick different actions in"] # [doc = "reaction to key modifiers being pressed. One common design that"] # [doc = "is used in major toolkits (and the behavior recommended for"] # [doc = "compositors) is:"] # [doc = ""] # [doc = "- If no modifiers are pressed, the first match (in bit order)"] # [doc = "will be used."] # [doc = "- Pressing Shift selects \"move\", if enabled in the mask."] # [doc = "- Pressing Control selects \"copy\", if enabled in the mask."] # [doc = ""] # [doc = "Behavior beyond that is considered implementation-dependent."] # [doc = "Compositors may for example bind other modifiers (like Alt/Meta)"] # [doc = "or drags initiated with other buttons than BTN_LEFT to specific"] # [doc = "actions (e.g. \"ask\")."] # [doc = ""] # [derive (Debug , PartialEq , Eq , PartialOrd , Ord , Hash , Clone , Copy)] pub struct DndAction : u32 { # [doc = "no action"] const None = 0u32 ; # [doc = "copy action"] const Copy = 1u32 ; # [doc = "move action"] const Move = 2u32 ; # [doc = "ask action"] const Ask = 4u32 ; } }
        ...
        pub trait WlDataDeviceManager {
            ...
            async fn get_data_device(
                ...
                tracing::debug!("-> wl_data_device_manager#{}.get_data_device()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
    ...
    pub mod wl_shell {
        ...
        pub trait WlShell {
            ...
            async fn get_shell_surface(
                ...
                tracing::debug!("-> wl_shell#{}.get_shell_surface()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
    ...
    pub mod wl_shell_surface {
        ...
        #[allow(unused)]
        use std::os::fd::AsRawFd;
        bitflags::bitflags! { # [doc = ""] # [doc = "These values are used to indicate which edge of a surface"] # [doc = "is being dragged in a resize operation. The server may"] # [doc = "use this information to adapt its behavior, e.g. choose"] # [doc = "an appropriate cursor image."] # [doc = ""] # [derive (Debug , PartialEq , Eq , PartialOrd , Ord , Hash , Clone , Copy)] pub struct Resize : u32 { # [doc = "no edge"] const None = 0u32 ; # [doc = "top edge"] const Top = 1u32 ; # [doc = "bottom edge"] const Bottom = 2u32 ; # [doc = "left edge"] const Left = 4u32 ; # [doc = "top and left edges"] const TopLeft = 5u32 ; # [doc = "bottom and left edges"] const BottomLeft = 6u32 ; # [doc = "right edge"] const Right = 8u32 ; # [doc = "top and right edges"] const TopRight = 9u32 ; # [doc = "bottom and right edges"] const BottomRight = 10u32 ; } }
        ...
        bitflags::bitflags! { # [doc = ""] # [doc = "These flags specify details of the expected behaviour"] # [doc = "of transient surfaces. Used in the set_transient request."] # [doc = ""] # [derive (Debug , PartialEq , Eq , PartialOrd , Ord , Hash , Clone , Copy)] pub struct Transient : u32 { # [doc = "do not set keyboard focus"] const Inactive = 1u32 ; } }
        ...
        pub trait WlShellSurface {
            ...
            async fn pong(
                ...
                tracing::debug!("-> wl_shell_surface#{}.pong()", sender_id);
            ...
            async fn r#move(
                ...
                tracing::debug!("-> wl_shell_surface#{}.move()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(seat))
                    .put_uint(serial)
                    .build();
            ...
            async fn resize(
                ...
                tracing::debug!("-> wl_shell_surface#{}.resize()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(seat))
                    .put_uint(serial)
                    .put_uint(edges.bits())
            ...
            async fn set_transient(
                ...
                tracing::debug!("-> wl_shell_surface#{}.set_transient()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
            ...
            async fn set_fullscreen(
                ...
                tracing::debug!("-> wl_shell_surface#{}.set_fullscreen()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
            ...
            async fn set_popup(
                ...
                tracing::debug!("-> wl_shell_surface#{}.set_popup()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(seat))
                    .put_uint(serial)
                    .put_object(Some(parent))
            ...
            async fn set_maximized(
                ...
                tracing::debug!("-> wl_shell_surface#{}.set_maximized()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(output)
                    .build();
                client
            ...
            async fn set_title(
                ...
                tracing::debug!("-> wl_shell_surface#{}.set_title()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
            ...
            async fn set_class(
                ...
                tracing::debug!("-> wl_shell_surface#{}.set_class()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
    ...
    pub mod wl_surface {
        ...
        pub trait WlSurface {
            ...
            async fn attach(
                ...
                tracing::debug!("-> wl_surface#{}.attach()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(buffer)
                    .put_int(x)
                    .put_int(y)
            ...
            async fn damage(
                ...
                tracing::debug!("-> wl_surface#{}.damage()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_int(x)
                    .put_int(y)
                    .put_int(width)
            ...
            async fn frame(
                ...
                tracing::debug!("-> wl_surface#{}.frame()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(callback))
                    .build();
                client
            ...
            async fn set_opaque_region(
                ...
                tracing::debug!("-> wl_surface#{}.set_opaque_region()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(region)
                    .build();
                client
            ...
            async fn set_input_region(
                ...
                tracing::debug!("-> wl_surface#{}.set_input_region()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(region)
                    .build();
                client
            ...
            async fn set_buffer_transform(
                ...
                tracing::debug!("-> wl_surface#{}.set_buffer_transform()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
            ...
            async fn set_buffer_scale(
                ...
                tracing::debug!("-> wl_surface#{}.set_buffer_scale()", sender_id);
            ...
            async fn damage_buffer(
                ...
                tracing::debug!("-> wl_surface#{}.damage_buffer()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_int(x)
                    .put_int(y)
                    .put_int(width)
            ...
            async fn offset(
                ...
                tracing::debug!("-> wl_surface#{}.offset()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_int(x)
                    .put_int(y)
                    .build();
    ...
    pub mod wl_seat {
        ...
        #[allow(unused)]
        use std::os::fd::AsRawFd;
        bitflags::bitflags! { # [doc = ""] # [doc = "This is a bitmask of capabilities this seat has; if a member is"] # [doc = "set, then it is present on the seat."] # [doc = ""] # [derive (Debug , PartialEq , Eq , PartialOrd , Ord , Hash , Clone , Copy)] pub struct Capability : u32 { # [doc = "the seat has pointer devices"] const Pointer = 1u32 ; # [doc = "the seat has one or more keyboards"] const Keyboard = 2u32 ; # [doc = "the seat has touch devices"] const Touch = 4u32 ; } }
        ...
        pub trait WlSeat {
            ...
            async fn get_pointer(
                ...
                tracing::debug!("-> wl_seat#{}.get_pointer()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .build();
                client
            ...
            async fn get_keyboard(
                ...
                tracing::debug!("-> wl_seat#{}.get_keyboard()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .build();
                client
            ...
            async fn get_touch(
                ...
                tracing::debug!("-> wl_seat#{}.get_touch()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .build();
                client
    ...
    pub mod wl_pointer {
        ...
        pub trait WlPointer {
            ...
            async fn set_cursor(
                ...
                tracing::debug!("-> wl_pointer#{}.set_cursor()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_uint(serial)
                    .put_object(surface)
                    .put_int(hotspot_x)
    ...
    pub mod wl_output {
        ...
        bitflags::bitflags! { # [doc = ""] # [doc = "These flags describe properties of an output mode."] # [doc = "They are used in the flags bitfield of the mode event."] # [doc = ""] # [derive (Debug , PartialEq , Eq , PartialOrd , Ord , Hash , Clone , Copy)] pub struct Mode : u32 { # [doc = "indicates this is the current mode"] const Current = 1u32 ; # [doc = "indicates this is the preferred mode"] const Preferred = 2u32 ; } }
    ...
    pub mod wl_region {
        ...
        pub trait WlRegion {
            ...
            async fn add(
                ...
                tracing::debug!("-> wl_region#{}.add()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_int(x)
                    .put_int(y)
                    .put_int(width)
            ...
            async fn subtract(
                ...
                tracing::debug!("-> wl_region#{}.subtract()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_int(x)
                    .put_int(y)
                    .put_int(width)
    ...
    pub mod wl_subcompositor {
        ...
        pub trait WlSubcompositor {
            ...
            async fn get_subsurface(
                ...
                tracing::debug!("-> wl_subcompositor#{}.get_subsurface()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(id))
                    .put_object(Some(surface))
                    .put_object(Some(parent))
    ...
    pub mod wl_subsurface {
        ...
        pub trait WlSubsurface {
            ...
            async fn set_position(
                ...
                tracing::debug!("-> wl_subsurface#{}.set_position()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_int(x)
                    .put_int(y)
                    .build();
            ...
            async fn place_above(
                ...
                tracing::debug!("-> wl_subsurface#{}.place_above()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
            ...
            async fn place_below(
                ...
                tracing::debug!("-> wl_subsurface#{}.place_below()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(sibling))
                    .build();
                client
    ...
    pub mod wl_fixes {
        ...
        pub trait WlFixes {
            ...
            #[doc = ""]
            async fn destroy_registry(
                &self,
                client: &mut crate::server::Client,
                sender_id: crate::wire::ObjectId,
                registry: crate::wire::ObjectId,
            ) -> crate::client::Result<()> {
                tracing::debug!("-> wl_fixes#{}.destroy_registry()", sender_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
                    .put_object(Some(registry))
                    .build();
                client
