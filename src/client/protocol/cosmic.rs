    ...
    pub mod zcosmic_workspace_manager_v1 {
        ...
        pub trait ZcosmicWorkspaceManagerV1 {
            ...
            async fn commit(
                ...
                tracing::debug!("-> zcosmic_workspace_manager_v1#{}.commit()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new().build();
                socket
                    .send(crate::wire::Message::new(object_id, 0u16, payload, fds))
                    .await
            ...
            async fn stop(
                ...
                tracing::debug!("-> zcosmic_workspace_manager_v1#{}.stop()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new().build();
                socket
                    .send(crate::wire::Message::new(object_id, 1u16, payload, fds))
                    .await
    ...
    pub mod zcosmic_workspace_handle_v1 {
        ...
        pub trait ZcosmicWorkspaceHandleV1 {
            ...
            async fn destroy(
                ...
                tracing::debug!("-> zcosmic_workspace_handle_v1#{}.destroy()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new().build();
                socket
                    .send(crate::wire::Message::new(object_id, 0u16, payload, fds))
                    .await
            ...
            async fn activate(
                ...
                tracing::debug!("-> zcosmic_workspace_handle_v1#{}.activate()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new().build();
                socket
                    .send(crate::wire::Message::new(object_id, 1u16, payload, fds))
                    .await
            ...
            async fn deactivate(
                ...
                tracing::debug!("-> zcosmic_workspace_handle_v1#{}.deactivate()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new().build();
                socket
                    .send(crate::wire::Message::new(object_id, 2u16, payload, fds))
                    .await
            ...
            async fn remove(
                ...
                tracing::debug!("-> zcosmic_workspace_handle_v1#{}.remove()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new().build();
                socket
                    .send(crate::wire::Message::new(object_id, 3u16, payload, fds))
                    .await
            ...
            async fn rename(
                ...
                tracing::debug!("-> zcosmic_workspace_handle_v1#{}.rename()", object_id);
                let (payload, fds) = crate::wire::PayloadBuilder::new()
